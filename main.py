...
class CamouflageApp(App):
    ...
    def build(self):
        ...
        tiny = Label(
            text="Image 000 | essai 0000 | total 000000",
            size_hint_y=None,
            height=dp(20),
            font_size=sp(11),
            color=C["text_muted"],
        ...
        self.progress_text = self._small_label("0 / 0 validé(s) | tentatives 0")
    ...
    def update_attempt_status(
        ...
        if self.progress_text is not None:
            self.progress_text.text = (
                f"{accepted_count} / {target_total} validé(s) | tentatives {global_attempt}"
            )
